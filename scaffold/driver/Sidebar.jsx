      ...
      <div className='flex flex-col px-1 gap-1'>
        <Link
          className={`p-3 flex gap-3 items-center rounded-lg text-sm focus:bg-default-100 focus:text-primary hover:bg-default-50 hover:text-primary ${
            pathname == '/driver/dashboard' ? 'bg-default-100 text-primary' : ''
          }`}
        ...
        <Link
          className={`p-3 flex gap-3 items-center rounded-lg text-sm focus:bg-default-100 focus:text-primary hover:bg-default-50 hover:text-primary ${
            pathname == '/driver/drop-points'
              ? 'bg-default-200 text-primary'
              : ''
          }`}
          href='/driver/agencies'
        >
        ...
        <Link
          className={`p-3 flex gap-3 items-center rounded-lg text-sm focus:bg-default-100 focus:text-primary hover:bg-default-50 hover:text-primary ${
            pathname == '/driver/pickups' ? 'bg-default-100 t2xt-primary' : ''
          }`}
          href='/driver/pickups'
        >
